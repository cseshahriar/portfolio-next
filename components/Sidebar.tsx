...
const Sidebar: FC<SidebarProps> = ({isOpen, onClose, pathname}) => {
    ...
    return (
        <div
            ref={sidebarRef}
            className={`fixed inset-y-0 right-0 z-50 min-w-72 bg-bodyColor border-1 border-1-hoverColor/20 transform ${isOpen ? "translate-x-0" : "translate-x-full"} hoverEffect`}>
